    ...
    <footer>
            <div className="section-container py-[50px] sm:py-[100px] text-sm flex flex-col space-y-8 text-center justify-between items-center sm:flex-row sm:space-y-0">
                ...
                <div className="flex space-x-8">
                    <a className="text-base" href="https://www.instagram.com/nemanjaphotography_/" target="_blank" aria-label="Visit Instagram page">
                        <FaInstagram/>
                    </a>
                    <a className="text-base" href="https://www.facebook.com/profile.php?id=100032362046704" target="_blank" aria-label="Visit Facebook page">
                        <FaFacebookF/>
                    </a>
                </div>
            </div>
