              ...
              <div className="lg:flex items-center lg:gap-24">
                ...
                <div className="lg:w-1/2">
                  ...
                  <p className="mb-4">
                    ...
                    capturing the world around me. Over time, this curiosity
                    grew into a deep love for photography. I find joy in
                    exploring the diverse landscapes and vibrant cultures of my
                    homeland, always seeking to capture moments that tell a
                    story.
                  </p>
                  <p className="mb-4">
